...
export default function Create({ areas = [], potentialHeads = [] }) {
    // Extraemos las acciones y el estado del formulario del hook
    const { form, store, toggleHead } = useDepartmentActions();
                    ...
                    <div className="w-full max-w-2xl space-y-8">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    ...
                                    if (availableHeads.length === 0) {
                                        return (
                                            <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-zinc-200 bg-white py-10 dark:border-zinc-800 dark:bg-zinc-950">
                                                <span className="mb-2 text-2xl"></span>
                                                <p className="px-4 text-center text-sm font-medium text-zinc-500">
                                                    No hay administradores registrados en el área seleccionada.
                                                </p>
                                            </div>
                                        );
                                    }
                            ...
                            <div className="space-y-3 md:col-span-2">
                                ...
                                <textarea
                                    id="description"
                                    placeholder="Describe brevemente las funciones de este departamento (opcional)..."
